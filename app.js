...
const products = [
    { 
        ...
        vector: [0.85, 0.3, 0.1, 0.2, 0.0], color: 'white', 
        category: 'top',
    ...
    { 
        ...
        vector: [0.2, 0.95, 0.4, 0.1, 0.0], color: 'black',
        category: 'bottom',
    ...
    { 
        ...
        vector: [0.2, 0.1, 0.9, 0.3, 0.2], color: 'navy',
        category: 'outer',
    ...
    { 
        ...
        vector: [0.5, 0.4, 0.2, 0.85, 0.1], color: 'blue',
        category: 'outer',
    ...
    { 
        ...
        vector: [0.95, 0.2, 0.4, 0.1, 0.1], color: 'beige',
        category: 'top',
    ...
    { 
        ...
        vector: [0.6, 0.1, 0.4, 0.7, 0.2], color: 'grey',
        category: 'top',
    ...
    { 
        ...
        vector: [0.1, 0.9, 0.2, 0.3, 0.0], color: 'khaki',
        category: 'bottom',
        targetBody: { height: [160, 190], weight: [50, 95] },
    ...
    { 
        ...
        vector: [0.8, 0.0, 0.9, 0.2, 0.3], color: 'black',
        category: 'dress',
    ...
    { 
        ...
        vector: [0.3, 0.2, 0.1, 0.9, 0.5], color: 'pattern',
        category: 'top',
    ...
    { 
        ...
        vector: [0.0, 0.9, 0.4, 0.1, 0.0], color: 'black',
        category: 'outer',
    ...
    { 
        ...
        vector: [0.4, 0.1, 0.8, 0.9, 0.3], color: 'brown',
        category: 'outer',
    ...
    { 
        ...
        vector: [0.9, 0.2, 0.1, 0.1, 0.0], color: 'white',
        category: 'bottom',
        targetBody: { height: [150, 200], weight: [40, 120] },
        image: 'shop imags/kennethmcandrew-boxer-shorts-335120_640.jpg' 
    },
    { 
        id: 113, name: 'Medieval Velvet Gown', brand: 'HistoricalCharm', price: '250,000', priceRaw: 250000,
        vector: [0.1, 0.0, 0.6, 0.9, 0.8], color: 'red',
        category: 'dress',
        targetBody: { height: [155, 180], weight: [45, 75] },
        image: 'shop imags/publicdomainpictures-medieval-276019_640.jpg' 
    },
    { 
        id: 114, name: 'Tropical Summer Bikini', brand: 'SunSplash', price: '45,000', priceRaw: 45000,
        vector: [0.7, 0.5, 0.1, 0.2, 0.0], color: 'pattern',
        category: 'top',
    ...
    { 
        ...
        vector: [0.6, 0.8, 0.1, 0.5, 0.1], color: 'blue',
        category: 'bottom',
    ...
    { 
        ...
        vector: [0.8, 0.2, 0.4, 0.6, 0.1], color: 'pattern',
        category: 'dress',
    ...
    { 
        ...
        vector: [0.1, 0.1, 0.6, 0.4, 1.0], color: 'blue',
        category: 'dress',
...
function renderCoordiSet() {
    ...
    const likedList = products.filter(p => likedProducts.has(p.id));
